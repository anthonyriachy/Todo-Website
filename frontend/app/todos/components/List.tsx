...
import { deleteTodo, setLoading, setTodos, updateTodo } from '@/GlobalRedux/Features/Todos/TodoSlice'
...
function List() {
    ...
    const handleDelete = async(todoId:string)=>{
        try {
            ...
            if(!response.ok){
                console.log('error in repsonse while delelting the todo '+response.statusText)
                return;
            }
            const data=await response.json();
    ...
    const handleCheck=async(todoId:string,check:boolean)=>{
        try {
            ...
            if(!response.ok){
                console.log('error in repsonse while updating the todo '+response.statusText)
                return;
            }
            const data=await response.json();
            console.log("todoid: "+todoId)
